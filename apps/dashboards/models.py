...
class Dashboard(models.Model):
    ...
    status = models.CharField(
        max_length=50, choices=DashboardStatus.choices, default=DashboardStatus.SANDBOX
    )
...
class GroupDashboard(models.Model):
    ...
    dashboards = models.ManyToManyField(
        Dashboard, related_name="dashboard_groups", blank=True, null=True
    )
...
auditlog.register(GroupDashboard)
