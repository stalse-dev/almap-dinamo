...
class MetabaseEmbeddingTests(TestCase):
    ...
    @patch("apps.dashboards.utils.METABASE_EMBEDDING_BASE_URL", "http://metabase.example.com")
    ...
    def test_get_embed_metabase_url_success(self, mock_get_token_metabase):
        ...
        expected_url = "http://metabase.example.com/embed/dashboard/test-token#bordered=true"
    ...
    def test_get_token_metabase_success(self, mock_jwt_encode):
        ...
        mock_jwt_encode.assert_called_once_with(payload, "test-secret-key", algorithm="HS256")
